...
BEGIN
	...
	IF @InStock is null AND @AuthorName is null AND @Genre is null
		BEGIN
		SELECT b.isbn AS ISBN,b.title AS Title,a.author_lastname + ', ' + a.author_firstname AS AuthorName,g.genre_type AS Genre,b.in_stock AS 'In Stock', b.quantity AS Qty,b.location AS Location,b.price AS Price
		FROM dbo.Book b
